...
detectado, [abra uma issue](https://github.com/jIDvDIj/slot2sync/issues) informando o
...
[Abra uma issue no GitHub](https://github.com/jIDvDIj/slot2sync/issues) descrevendo o
problema, com a versão do Slot2Sync e do sistema operacional. Se for uma vulnerabilidade
de segurança, siga o processo de divulgação responsável em
[`SECURITY.md`](https://github.com/jIDvDIj/slot2sync/blob/main/SECURITY.md) em vez de
