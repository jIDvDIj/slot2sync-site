...
- Uma conta Google (para conectar ao Google Drive).

## Próximo passo

Depois de instalar, siga para [Primeiros passos](primeiros-passos.md) para conectar sua
conta e apontar a pasta do emulador.
