...
(comum, autenticação, emulador, biblioteca, configurações, erros). Isso mantém PRs de
tradução restritos ao módulo relevante, e erros de tipo apontam direto para o arquivo e a
chave problemática.
